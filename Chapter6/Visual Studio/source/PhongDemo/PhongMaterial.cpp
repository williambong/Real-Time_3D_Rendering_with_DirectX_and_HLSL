...
namespace Rendering
{
	...
	MATERIAL_VARIABLE_DEFINITION(PhongMaterial, WorldViewProjection)
	MATERIAL_VARIABLE_DEFINITION(PhongMaterial, World)
	MATERIAL_VARIABLE_DEFINITION(PhongMaterial, SpecularColor)
	MATERIAL_VARIABLE_DEFINITION(PhongMaterial, SpecularPower)
	MATERIAL_VARIABLE_DEFINITION(PhongMaterial, AmbientColor)
	MATERIAL_VARIABLE_DEFINITION(PhongMaterial, LightColor)
	MATERIAL_VARIABLE_DEFINITION(PhongMaterial, LightDirection)
	MATERIAL_VARIABLE_DEFINITION(PhongMaterial, CameraPosition)
	MATERIAL_VARIABLE_DEFINITION(PhongMaterial, ColorTexture)
	...
	void PhongMaterial::CreateVertexBuffer(ID3D11Device* device, VertexPositionTextureNormal* vertices, UINT vertexCount, ID3D11Buffer** vertexBuffer) const
	{
