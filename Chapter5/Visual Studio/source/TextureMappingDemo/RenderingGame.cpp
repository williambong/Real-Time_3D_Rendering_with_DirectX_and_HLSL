...
namespace Rendering
{
    ...
    void RenderingGame::Initialize()
    {
		...
		mTextureMappingDemo = new TextureMappingDemo(*this, *mCamera);
        mComponents.push_back(mTextureMappingDemo);
    ...
    {
		DeleteObject(mTextureMappingDemo);
		DeleteObject(mGrid)
