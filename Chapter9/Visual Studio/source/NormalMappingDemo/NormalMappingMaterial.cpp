...
namespace Rendering
{
	...
	NormalMappingMaterial::NormalMappingMaterial()
		: Material("main10"),
		  ...
		  MATERIAL_VARIABLE_INITIALIZATION(ColorTexture), MATERIAL_VARIABLE_INITIALIZATION(NormalMap)
	{
	}
	...
	void NormalMappingMaterial::CreateVertexBuffer(ID3D11Device* device, VertexPositionTextureNormalTangent* vertices, UINT vertexCount, ID3D11Buffer** vertexBuffer) const
	{
