...
namespace Rendering
{
    RTTI_DEFINITIONS(HelloStructsDemo)

    HelloStructsDemo::HelloStructsDemo(Game& game, Camera& camera)
    ...
    HelloStructsDemo::~HelloStructsDemo()
    {
    ...
    void HelloStructsDemo::Initialize()
    {
		...
		mEffect->CompileFromFile(L"Content\\Effects\\HelloStructs.fx");

        mMaterial = new HelloStructsMaterial();
    ...
    void HelloStructsDemo::Draw(const GameTime& gameTime)
    {
