...
namespace Rendering
{
	...
	ComputeShaderMaterial::ComputeShaderMaterial()
		: Material("compute"),
		  MATERIAL_VARIABLE_INITIALIZATION(TextureSize), MATERIAL_VARIABLE_INITIALIZATION(BlueColor),
		  MATERIAL_VARIABLE_INITIALIZATION(OutputTexture), MATERIAL_VARIABLE_INITIALIZATION(ColorTexture)
	{
	}
	...
	void ComputeShaderMaterial::CreateVertexBuffer(ID3D11Device* device, const Mesh& mesh, ID3D11Buffer** vertexBuffer) const
	{
