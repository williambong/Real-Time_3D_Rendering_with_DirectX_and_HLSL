...
namespace Rendering
{
    ...
    RenderingGame::RenderingGame(HINSTANCE instance, const std::wstring& windowClass, const std::wstring& windowTitle, int showCommand)
        :  Game(instance, windowClass, windowTitle, showCommand),
           ...
           mProjectiveTextureMappingSimpleDemo(nullptr)
    {
    ...
    void RenderingGame::Initialize()
    {
		...
		mProjectiveTextureMappingSimpleDemo = new ProjectiveTextureMappingSimpleDemo(*this, *mCamera);
		mComponents.push_back(mProjectiveTextureMappingSimpleDemo);
    ...
    {
		DeleteObject(mProjectiveTextureMappingSimpleDemo);
