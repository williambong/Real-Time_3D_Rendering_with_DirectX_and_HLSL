...
namespace Rendering
{
    ...
    RenderingGame::RenderingGame(HINSTANCE instance, const std::wstring& windowClass, const std::wstring& windowTitle, int showCommand)
        :  Game(instance, windowClass, windowTitle, showCommand),
           ...
           mProjectiveTextureMappingDepthMapDemo(nullptr)
    {
    ...
    void RenderingGame::Initialize()
    {
		...
		mProjectiveTextureMappingDepthMapDemo = new ProjectiveTextureMappingDepthMapDemo(*this, *mCamera);
		mComponents.push_back(mProjectiveTextureMappingDepthMapDemo);
    ...
    {
		DeleteObject(mProjectiveTextureMappingDepthMapDemo);
