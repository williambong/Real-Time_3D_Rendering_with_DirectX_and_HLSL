...
namespace Rendering
{
	...
	EnvironmentMappingMaterial::EnvironmentMappingMaterial()
		: Material("main10"),
		  MATERIAL_VARIABLE_INITIALIZATION(WorldViewProjection), MATERIAL_VARIABLE_INITIALIZATION(World),
		  MATERIAL_VARIABLE_INITIALIZATION(AmbientColor), MATERIAL_VARIABLE_INITIALIZATION(EnvColor),
		  MATERIAL_VARIABLE_INITIALIZATION(ReflectionAmount), MATERIAL_VARIABLE_INITIALIZATION(ColorTexture),
		  MATERIAL_VARIABLE_INITIALIZATION(EnvironmentMap), MATERIAL_VARIABLE_INITIALIZATION(CameraPosition)
	{
	}
	...
	void EnvironmentMappingMaterial::CreateVertexBuffer(ID3D11Device* device, VertexPositionTextureNormal* vertices, UINT vertexCount, ID3D11Buffer** vertexBuffer) const
	{
